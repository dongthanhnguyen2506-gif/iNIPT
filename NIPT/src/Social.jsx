  ...
  return (
    <section id="team" className="section-sm bg-white" aria-labelledby="team-h2">
      <div className="container-main">
        ...
        <div className="flex gap-4 overflow-x-auto pb-4 sm:grid sm:grid-cols-3 lg:grid-cols-5 sm:overflow-visible sm:pb-0 -mx-4 sm:mx-0 px-4 sm:px-0">
          {EXPERTS.map(e => (
            <div key={e.init}
              className="card p-5 flex-shrink-0 w-52 sm:w-auto text-center hover:shadow-card-hover transition-all">
