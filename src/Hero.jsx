...
const SLIDES = [
  { img: IMG_B1, alt: 'Me bau chau A — iNIPT sang loc truoc sinh Invivo Lab', caption: 'An toan · Khong xam lan',    pos: 'center 18%' },
  { img: IMG_B2, alt: 'Vo chong me bau chau A — iNIPT 7+ khuyen nghi',        caption: 'Dong hanh cung gia dinh',   pos: 'center 22%' },
  { img: IMG_B4, alt: 'Gia dinh me bau voi be gai — iNIPT+ kem gene lan',      caption: 'Tu tuan thai thu 9',        pos: 'center 20%' },
  { img: IMG_B5, alt: 'Me bau voi giay baby xanh — xet nghiem NIPT Invivo Lab', caption: 'Ket qua 5-7 ngay',         pos: 'center 35%' },
];
...
export default function Hero() {
  ...
  return (
    <section
      ...
      aria-label="Gioi thieu iNIPT Invivo Lab"
    >
      ...
      <div className="flex flex-col lg:hidden pt-16">
        ...
        >
          ...
          {[['prev', prev, 'left-3', 'M15 19l-7-7 7-7'], ['next', next, 'right-3', 'M9 5l7 7-7 7']].map(([key, fn, pos, d]) => (
            <button
              key={key}
              onClick={fn}
              ...
              aria-label={key === 'prev' ? 'Anh truoc' : 'Anh sau'}
            >
        ...
        <div className="px-4 pt-5 pb-24">
          <div className="inline-flex items-center gap-1.5 bg-white border border-blue-100 rounded-full px-3 py-1 text-[11px] font-bold text-brand-blueMid shadow-sm mb-3">
            ...
            Xet nghiem NIPT · Khong xam lan · 2026
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center py-12">
            ...
            <div className="animate-fade-up">
              <div className="inline-flex items-center gap-2 bg-white/80 border border-blue-100 rounded-full px-4 py-1.5 text-xs font-bold text-brand-blueMid shadow-card mb-5">
                ...
                Xet nghiem NIPT · Khong xam lan · Invivo Lab 2026
              </div>
              ...
              <div className="flex gap-3 mb-9">
                <button onClick={() => scrollTo('#quiz')} className="btn-primary text-base px-7 py-3.5">
                  &#127807; B&#7855;t &#273;&#7847;u c&#249;ng B&#233; M&#7847;m
                </button>
                <button onClick={() => scrollTo('#nipt-what')} className="btn-outline px-6 py-3.5">
                  iNIPT l&#224; g&#236;?
                </button>
              </div>
              ...
              <div className="absolute -left-12 bottom-20 animate-float bg-white rounded-2xl shadow-float border border-blue-50 p-3">
                <div className="flex items-end gap-2">
                  ...
                  <div className="bg-brand-blueLight rounded-xl rounded-bl-none px-3 py-2 text-[11px] font-bold text-brand-blue max-w-[110px] leading-relaxed">
                    Me muon biet goi phu hop? &#127823;
                  </div>
                </div>
              </div>

              <div
                className="absolute -right-5 top-10 bg-white rounded-2xl shadow-card border border-green-100 px-4 py-3 animate-float"
                style={{ animationDelay: '1s' }}
              >
                <div className="text-xl font-black text-brand-blue">99,9%</div>
                <div className="text-[10px] text-slate-500 font-semibold">Do dac hieu</div>
              </div>
            </div>
          </div>
        </div>
