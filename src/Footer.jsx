...
export function Footer() {
  return (
    <footer className="bg-black pt-12 pb-6" role="contentinfo">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[13px] text-slate-400 leading-relaxed mb-5">
              Invivo Lab cung cấp dịch vụ xét nghiệm gene và sàng lọc di truyền
              chất lượng cao, đồng hành cùng bác sĩ và gia đình Việt.
            </p>
            <a
              href="tel:19008668"
