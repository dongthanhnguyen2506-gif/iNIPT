...
export default function ContactForm() {
      ...
      <section id="form" className="section bg-white">
        <div className="container-main max-w-lg mx-auto text-center">
          ...
          <p className="text-slate-500 text-sm leading-relaxed mb-6">
            ...
            <strong>{form.name}</strong> sớm nhất. Mẹ cũng có thể gọi ngay
            hotline để được tư vấn nhanh hơn.
          </p>
  ...
  const inputCls = (field) =>
    [
      'w-full border rounded-xl px-4 py-3 text-sm font-medium outline-none',
      'transition-all duration-200 bg-white focus:ring-2 focus:ring-brand-blue/20',
      errors[field]
    ...
    <section id="form" className="section bg-white" aria-labelledby="form-h2">
      <div className="container-main max-w-xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h2
            id="form-h2"
            className="text-2xl sm:text-3xl font-black text-slate-900 mt-4 mb-2"
          >
              ...
              <div className="grid grid-cols-2 gap-2">
                {NEEDS.map((n) => (
                  <label
                    key={n.id}
                    className={[
                      'flex items-center gap-2.5 border rounded-xl px-3 py-2.5',
